...
public class DatabaseMetricValue {
    ...
    public DatabaseMetricValue(String type, ResultSet resultSet) throws SQLException, BadDataException {
        ...
        group_count_val = resultSet.getLong("group_count_val");
        count_val = resultSet.getLong("count_val");
        sum_val = resultSet.getLong("sum_val");
        min_val = resultSet.getLong("min_val");
        max_val = resultSet.getLong("max_val");
